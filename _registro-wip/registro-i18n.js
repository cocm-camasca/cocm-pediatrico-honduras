...
const REG_I18N = {
  ...
  med_reason_anxiety:    { es: 'Ansiedad',      en: 'Anxiety' },
  med_reason_depression: { es: 'Depresión',     en: 'Depression' },
  med_reason_adhd:       { es: 'TDAH',          en: 'ADHD' },
  med_reason_ptsd:       { es: 'Trauma / PTSD', en: 'PTSD' },
